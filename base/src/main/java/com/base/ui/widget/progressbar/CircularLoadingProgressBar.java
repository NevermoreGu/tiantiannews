package com.base.ui.widget.progressbar;
...
public class CircularLoadingProgressBar extends View implements DialogAinm {
    ...
    public CircularLoadingProgressBar(Context context) {
        this(context, null);
    }

    public CircularLoadingProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularLoadingProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
