...
//    }
//
//    public static void setTranslucentFor(Activity activity, View needOffsetView) {
//        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
//            return;
//        }
//        setTransparentForWindow(activity);
...
////            }
////            fakeTranslucentView.setBackgroundColor(activity.getResources().getColor(R.color.transparent));
////        }
////        if (needOffsetView != null) {
////            Object haveSetOffset = needOffsetView.getTag(TAG_KEY_HAVE_SET_OFFSET);
////            if (haveSetOffset != null && (Boolean) haveSetOffset) {
...
//                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
//        statusBarView.setLayoutParams(params);
//        statusBarView.setBackgroundColor(Color.argb(alpha, 255, 31, 156));
