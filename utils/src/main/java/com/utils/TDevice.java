...
public class TDevice {
    ...
    public static int getDefaultLoadFactor() {
        if (_loadFactor == null) {
            Integer integer = Integer.valueOf(0xf & AppContext.getAppContext()
    ...
    public static DisplayMetrics getDisplayMetrics() {
        ...
        ((WindowManager) AppContext.getAppContext().getSystemService(
...
//        return udid;
    ...
    public static boolean hasBigScreen() {
        ...
        if (_hasBigScreen == null) {
            boolean flag1;
            if ((0xf & AppContext.getAppContext().getResources()
    ...
    public static boolean hasCamera() {
        if (_hasCamera == null) {
            PackageManager pckMgr = AppContext.getAppContext()
                    .getPackageManager();
            boolean flag = pckMgr
    ...
    public static boolean isPackageExist(String pckName) {
        try {
            PackageInfo pckInfo = AppContext.getAppContext().getPackageManager()
    ...
    public static void hideSoftKeyboard(View view) {
        if (view == null)
            return;
        ((InputMethodManager) AppContext.getAppContext().getSystemService(
    ...
    public static boolean isLandscape() {
        boolean flag;
        flag = AppContext.getAppContext().getResources().getConfiguration().orientation == 2;
        return flag;
    }

    public static boolean isPortrait() {
        boolean flag = true;
        if (AppContext.getAppContext().getResources().getConfiguration().orientation != 1)
            flag = false;
        return flag;
    }
    ...
    public static boolean isTablet() {
        if (_isTablet == null) {
            boolean flag;
            flag = (0xf & AppContext.getAppContext().getResources()
                    .getConfiguration().screenLayout) >= 3;
    ...
    public static String getCurCountryLan() {
        return AppContext.getAppContext().getResources().getConfiguration().locale
                .getLanguage()
                + "-"
                + AppContext.getAppContext().getResources().getConfiguration().locale
                .getCountry();
    }

    public static boolean isZhCN() {
        String lang = AppContext.getAppContext().getResources()
    ...
    public static boolean isScreenOn() {
        PowerManager pm = (PowerManager) AppContext.getAppContext()
    ...
    public static String getIMEI() {
        TelephonyManager tel = (TelephonyManager) AppContext.getAppContext()
    ...
    public static void openApp(Context context, String packageName) {
        Intent mainIntent = AppContext.getAppContext().getPackageManager()
    ...
    public static void copyTextToBoard(String string) {
        if (TextUtils.isEmpty(string))
            return;
        ClipboardManager clip = (ClipboardManager) AppContext.getAppContext().getSystemService(Context.CLIPBOARD_SERVICE);
        clip.setText(string);
    ...
    public static int getStatuBarHeight() {
        ...
        try {
            ...
            field = c.getField("status_bar_height");
            x = Integer.parseInt(field.get(obj).toString());
            sbar = AppContext.getAppContext().getResources()
                    .getDimensionPixelSize(x);
